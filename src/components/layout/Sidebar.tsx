      ...
      <div className="flex flex-col flex-1 min-h-0">
        ...
        <div className="flex items-center h-16 flex-shrink-0 px-4 bg-slate-900 border-b border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-lg tracking-tight">EPMS</span>
          </div>
        </div>
        ...
        {user && (
          <div className="px-4 py-3 border-b border-slate-700">
            ...
            <span className="inline-block mt-1 px-2 py-0.5 text-xs font-medium bg-indigo-500 text-white rounded-full capitalize">
              {user.role}
            </span>
          </div>
        )}
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`group flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-150 ${
                    isActive
